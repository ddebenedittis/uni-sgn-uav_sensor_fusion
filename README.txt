SCRIPTS:
	...
	main_2
		...
		Once the trajectory (not the scenario) has been changed it is necessary to recreate it by selecting the correct choice in the corresponding questdlg. Once this has been done, if there are no further changes in the trajectory, for later simulation it can be reused bu loading the saved trajectory data (this avoids the slow trajectory generation process).
	main_3
